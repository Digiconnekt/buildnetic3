...
<html lang="en">
  ...
  <body>
    ...
    <!-- hero section START -->
    <section
      class="landing-hero-section container-fluid py-5 mt-3"
    ...
    <section
      id="how-it-works"
      class="how-it-works-section container my-5"
        ...
        <div class="col-lg-6">
          <div class="row align-items-center">
            ...
            <div class="col-6 pt-5" data-aos="fade-up">
              <div class="image-block text-center">
                <img
                  src="./images/landing/how-it-works-2.png"
                  alt="Handpicked Candidates"
                  class="img-fluid"
                />
              </div>
            </div>
            ...
            <div class="col-6 pt-5 border-tracker" data-aos="fade-up">
              <div class="image-block text-center">
                <img
                  src="./images/landing/how-it-works-3.png"
                  alt="Hire"
                  class="img-fluid"
                />
              </div>
    ...
    <section
      id="why-us"
      class="why-us-section my-5 py-5"
      style="overflow-x: hidden; overflow-y: hidden"
    >
      <div class="container">
            ...
            <div class="row justify-content-around text-center">
              <div class="col-6 col-md-3">
                ...
                >
                  <div class="icon-block mb-2">
                    <img
                      src="./images/landing/why-us-1.png"
                      alt="Why Us"
                      class="img-fluid"
                    />
                  </div>
              ...
              <div class="col-6 col-md-3">
                ...
                >
                  <div class="icon-block mb-2">
                    <img
                      src="./images/landing/why-us-2.png"
                      alt="Why Us"
                      class="img-fluid"
                    />
                  </div>
              ...
              <div class="col-6 col-md-3 mt-4 mt-md-0">
                ...
                >
                  <div class="icon-block mb-2">
                    <img
                      src="./images/landing/why-us-3.png"
                      alt="Why Us"
                      class="img-fluid"
                    />
                  </div>
              ...
              <div class="col-6 col-md-3 mt-4 mt-md-0">
                ...
                >
                  <div class="icon-block mb-2">
                    <img
                      src="./images/landing/why-us-4.png"
                      alt="Why Us"
                      class="img-fluid"
                    />
                  </div>
    ...
    <section
      class="our-clients-section container-fluid mt-5 py-5"
      style="overflow-x: hidden; overflow-y: hidden"
    >
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-lg-9 mt-5 mt-lg-0">
            <div class="row">
              ...
              <div class="col-6 col-md-3">
                ...
                >
                  <img
                    src="./images/clients/life-trail.png"
                    alt="the life trail"
                  />
                </div>
                <div
