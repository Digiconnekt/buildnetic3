...
class __TwigTemplate_b2d0ce737b7c257bc4603ac35ffce245 extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"sparkline ";
        ...
        <div>
            ...
            if ( !twig_test_empty(((twig_get_attribute($this->env, $this->source, ($context["sparkline"] ?? null), "title", [], "any", true, true, false, 29)) ? (_twig_default_filter(twig_get_attribute($this->env, $this->source, ($context["sparkline"] ?? null), "title", [], "any", false, false, false, 29))) : ("")))) {
                ...
                echo \Piwik\piwik_escape_filter($this->env, $this->env->getFilter('rawSafeDecoded')->getCallable()(twig_get_attribute($this->env, $this->source, (isset($context["sparkline"]) || array_key_exists("sparkline", $context) ? $context["sparkline"] : (function () { throw new RuntimeError('Variable "sparkline" does not exist.', 29, $this->source); })()), "title", [], "any", false, false, false, 29)), "html_attr");
                echo "\">";
            ...
            if (twig_get_attribute($this->env, $this->source, (isset($context["sparkline"]) || array_key_exists("sparkline", $context) ? $context["sparkline"] : (function () { throw new RuntimeError('Variable "sparkline" does not exist.', 30, $this->source); })()), "url", [], "any", false, false, false, 30)) {
                echo $this->env->getFunction('sparkline')->getCallable()(twig_get_attribute($this->env, $this->source, (isset($context["sparkline"]) || array_key_exists("sparkline", $context) ? $context["sparkline"] : (function () { throw new RuntimeError('Variable "sparkline" does not exist.', 30, $this->source); })()), "url", [], "any", false, false, false, 30));
            }
            // line 31
            echo "        </div>
\t<div>
            ...
            foreach ($context['_seq'] as $context["groupName"] => $context["group"]) {
                ...
                ";
                    ...
                    if (twig_in_filter("%s", twig_get_attribute($this->env, $this->source, $context["metric"], "description", [], "any", false, false, false, 37))) {
                        // line 38
                        echo $this->env->getFilter('translate')->getCallable()(twig_get_attribute($this->env, $this->source, $context["metric"], "description", [], "any", false, false, false, 38), (("<strong>" . $this->env->getFilter('number')->getCallable()(twig_get_attribute($this->env, $this->source, $context["metric"], "value", [], "any", false, false, false, 38), 2)) . "</strong>"));
                    } else {
                        // line 40
                        echo "                    <strong>";
                        echo \Piwik\piwik_escape_filter($this->env, $this->env->getFilter('number')->getCallable()(twig_get_attribute($this->env, $this->source, $context["metric"], "value", [], "any", false, false, false, 40), 2), "html", null, true);
                        echo "</strong> ";
...
{% endmacro %}
", "@CoreVisualizations/macros.twig", "/home/u657051008/domains/buildnetic.com/public_html/wp-content/plugins/matomo/app/plugins/CoreVisualizations/templates/macros.twig");
    }
}
