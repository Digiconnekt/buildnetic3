...
class __TwigTemplate_d701657afc1986b268c82ed7016d7e66 extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"segment-element borderedControl expanded\">
        ...
        echo \Piwik\piwik_escape_filter($this->env, $this->env->getFilter('translate')->getCallable()("SegmentEditor_SaveAndApply"), "html", null, true);
        echo "</button>
        </div>
    </div>
</div>
...
", "@SegmentEditor/_segmentSelector.twig", "/home/u657051008/domains/buildnetic.com/public_html/wp-content/plugins/matomo/app/plugins/SegmentEditor/templates/_segmentSelector.twig");
    }
}
