...
if( function_exists( 'alvon_framework_init' ) ) {
    $alvon_team_single_breadcrumb_title = alvon_get_option('alvon_team_single_breadcrumb_title');
    $alvon_breadcrumb_switch = alvon_get_option('alvon_breadcrumb_switch');
} else {
    $alvon_team_single_breadcrumb_title = 'Team Details';
        ...
        <div class="row">
            <div class="col-12">
                <div class="breadcrumb-wrap text-center">
                    <h2><?php echo esc_html( $alvon_team_single_breadcrumb_title ); ?></h2>
