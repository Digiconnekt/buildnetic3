...
<!-- header -->
<header id="header-sticky" class="transparent-header <?php echo esc_attr( $breadcrumb_height.$auto_class ); ?> header1">
            ...
            <?php
              ...
              $auto_class = 'customizer-logo';
                ...
                $auto_class = 'option-logo';
                  ...
                  echo '<a href="'.esc_url(home_url('/')).'" class="default-logo">'. esc_html__( 'Alvon', 'alvon' ) .'</a></div>';
