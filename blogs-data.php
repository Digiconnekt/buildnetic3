...
$blogs = array(
  ...
  (object) array(
    ...
    "image" => "hire-remote-angular-developers-risky-or-rewarding-find-out-here.png",
    "href" => "hire-remote-angular-developers-risky-or-rewarding-find-out-here",
    "description" => "Businesses are constantly seeking innovative ways to enhance their online presence and streamline their operations. One of the most effective approaches to achieve this is by leveraging the power of Angular, a robust front-end web application framework. As the demand for skilled"
  ),
  (object) array(
    "title" => "React vs Vue - Make the Right Choice for Your Front-End Journey",
    "image" => "react-vs-vue-make-the-right-choice-for-your-front-end-journey.png",
    "href" => "react-vs-vue-make-the-right-choice-for-your-front-end-journey",
    "description" => "In the ever-evolving landscape of front-end development, choosing the right framework can be a crucial decision that impacts the success of your project. Two popular contenders in this space are React and Vue, both offering powerful tools for building modern user interfaces."
  ),
  (object) array(
