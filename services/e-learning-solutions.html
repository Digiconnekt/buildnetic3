...
<html lang="en">
  ...
  <body>
    ...
    <div class="single-service-page">
      <!-- title section start -->
      <div class="e-learning-banner title-section container-fuild mt-3">
        <div class="px-4 py-5 text-center">
          <!-- <h4 class="mb-3">
            Second-most widely installed mobile operating system
          </h4> -->
          <h1 class="display-5 fw-bold mb-3">E-Learning Solutions</h1>
        </div>
      </div>
      <!-- title section end -->
        ...
        <div class="row">
          <div class="col-12 col-md-6 mb-3 mb-md-0">
            <div class="img-block mx-auto">
              <img
                src="../images/services/single-services/e-learning/e-learning.jpg"
                alt="E-Learning"
              />
            </div>
          </div>
          <div class="col-12 col-md-6">
            ...
            <p>
              ...
              institutions, education content providers, and corporate training
              centers and even students extremely easy and effortless.
            </p>
          </div>
        </div>
      </div>
        ...
        <div class="container">
          ...
          <div class="row row-cols-1 row-cols-md-3 g-4">
            <div class="col-md-6">
              <div class="card">
                <img
                  src="../images/services/single-services/e-learning/services-we-offer-1.png"
                  class="card-img-top"
                  alt="Prosperous Learning atmosphere"
                />
                <div class="card-body">
                  <h5 class="card-title">Prosperous Learning atmosphere</h5>
                  <p class="card-text">
                    Bring alive your courses with 2D and 3D graphics, avatars,
                    quests, badges and more. Enable the real-time communication
                    tools to provide support for discussions, personal messages
                    and also calendar integration enhancing the student’s
                    growth.
                  </p>
                </div>
              </div>
            ...
            <div class="col-md-6">
              <div class="card">
                <img
                  src="../images/services/single-services/e-learning/services-we-offer-2.png"
                  class="card-img-top"
                  alt="Custom Learning Paths"
                />
                <div class="card-body">
                  <h5 class="card-title">Custom Learning Paths</h5>
                  <p class="card-text">
                    Build step-by-step or chapter-by-chapter educational guides
                    for employees or students. Effortlessly divide course
                    structure into chapters and sequences, for them to deep dive
                    into the subject and make the content engaging.
                  </p>
                </div>
              </div>
            </div>
            <div class="col-md-6">
              <div class="card">
                <img
                  src="../images/services/single-services/e-learning/services-we-offer-3.png"
                  class="card-img-top"
                  alt="Student Enrollment and Onboarding"
                />
                <div class="card-body">
                  <h5 class="card-title">Student Enrollment and Onboarding</h5>
                  <p class="card-text">
                    Make on-boarding smooth for students and administrators with
                    guided onboarding procedures. including customizable
                    enrollment steps with video orientation, welcome emails,
                    online slide presentations, digital handbooks and other
                    content.
                  </p>
                </div>
              </div>
            ...
            <div class="col-md-6">
              <div class="card">
                <img
                  src="../images/services/single-services/e-learning/services-we-offer-4.png"
                  class="card-img-top"
                  alt="Student Service Portal"
                />
                <div class="card-body">
                  <h5 class="card-title">Student Service Portal</h5>
                  <p class="card-text">
                    Develop customised student service portal with different
                    utility modules for career aid guidance, supplemental
                    programs, extracurricular activities, classes, on-campus
                    jobs, internship opportunities, and so much more.
                  </p>
                </div>
              </div>
            </div>
            <div class="col-md-6">
              <div class="card">
                <img
                  src="../images/services/single-services/e-learning/services-we-offer-5.png"
                  class="card-img-top"
                  alt="Progressive gamification"
                />
                <div class="card-body">
                  <h5 class="card-title">Progressive gamification</h5>
                  <p class="card-text">
                    Develop custom games for any course type be it e-learning,
                    corporate training, marketing and online shopping.
                  </p>
                </div>
              </div>
            </div>
