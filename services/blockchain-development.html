...
<html lang="en">
  ...
  <body>
    ...
    <div class="single-service-page">
      <!-- title section start -->
      <div class="blockchain-banner title-section container-fuild mt-3">
        <div class="px-4 py-5 text-center">
          <h4 class="mb-3">A Digital Ledger</h4>
          <h1 class="display-5 fw-bold mb-3">Blockchain Development</h1>
        </div>
      </div>
      <!-- title section end -->
        ...
        <div class="row">
          <div class="col-12 col-md-6 mb-3 mb-md-0">
            <div class="img-block mx-auto">
              <img
                src="../images/services/single-services/blockchain/blockchain.jpg"
                alt="Blockchain"
              />
            </div>
          </div>
          <div class="col-12 col-md-6">
            ...
            <p>
              The development of blockchain technology is accelerating. It has
              impacted many different types of business through its use in
              industries like healthcare, supply chain management, e-commerce,
              banking and finance, and digital recordkeeping. Users and business
              owners can store and conduct business transactions in the most
              secure and effective way possible thanks to distributed ledger
              technology. At Steady Rabbit, we think that using blockchain's
              advantages in conjunction with other services will help your
              company grow.
            </p>
            <ul>
              <li>Maximum openness for secure and safe business.</li>
              <li>
                Projects with agile development services that are affordable.
              </li>
              <li>Strict deadlines without compromising quality.</li>
              <li>
                Services following delivery to ensure successful installation.
              </li>
            </ul>
          </div>
        </div>
        ...
        <div class="container">
          ...
          <div class="row row-cols-1 row-cols-md-3 g-4">
            <div class="col-md-6">
              <div class="card">
                <img
                  src="../images/services/single-services/blockchain/services-we-offer-1.png"
                  class="card-img-top"
                  alt="Development Services by DEFI"
                />
                <div class="card-body">
                  <h5 class="card-title">Development Services by DEFI</h5>
                  <p class="card-text">
                    You can deliver cost-effective, highly adaptable, and
                    instantly scalable DeFi projects with the assistance of our
                    Decentralized Finance (DeFi) experts. We assist you with
                    quick transactions, automation, and planned investment
                    strategies.
                  </p>
                </div>
              </div>
            ...
            <div class="col-md-6">
              <div class="card">
                <img
                  src="../images/services/single-services/blockchain/services-we-offer-2.png"
                  class="card-img-top"
                  alt="Development services by NFT"
                />
                <div class="card-body">
                  <h5 class="card-title">Development services by NFT</h5>
                  <p class="card-text">
                    We have a team of professionals who can assist you in
                    creating non-fungible tokens (NFTs) for digital
                    collectibles, games, sports, music, movies, and other
                    things.
                  </p>
                </div>
              </div>
            ...
            <div class="col-md-6">
              <div class="card">
                <img
                  src="../images/services/single-services/blockchain/services-we-offer-3.png"
                  class="card-img-top"
                  alt="Services for Stablecoin Development"
                />
                <div class="card-body">
                  <h5 class="card-title">
                    Services for Stablecoin Development
                  </h5>
                  <p class="card-text">
                    We assist you in storing and sharing information in the most
                    secure manner possible using distributed blockchain ledger
                    technology by developing stablecoins.
                  </p>
                </div>
              </div>
            </div>
            <div class="col-md-6">
              <div class="card">
                <img
                  src="../images/services/single-services/blockchain/services-we-offer-4.png"
                  class="card-img-top"
                  alt="Development services for ICO"
                />
                <div class="card-body">
                  <h5 class="card-title">Development services for ICO</h5>
                  <p class="card-text">
                    We offer support for organizations looking to effectively
                    launch an initial coin offering (ICO) through token
                    development, ICO marketing, and community growth. Businesses
                    that use our optimal ICO development solutions can avoid any
                    rivalry.
                  </p>
                </div>
              </div>
            ...
            <div class="col-md-6">
              <div class="card">
                <img
                  src="../images/services/single-services/blockchain/services-we-offer-5.png"
                  class="card-img-top"
                  alt="Services for tokenization development"
                />
                <div class="card-body">
                  <h5 class="card-title">
                    Services for tokenization development
                  </h5>
                  <p class="card-text">
                    We support the creation of secure cryptocurrency backed by
                    actual assets. You can count on our team to tokenize your
                    digital assets while maintaining their security,
                    transparency, and legal tender compliance.
                  </p>
                </div>
              </div>
            </div>
            <div class="col-md-6">
              <div class="card">
                <img
                  src="../images/services/single-services/blockchain/services-we-offer-6.png"
                  class="card-img-top"
                  alt="Services for tokenization development"
                />
                <div class="card-body">
            ...
            <div class="col-md-6">
              <div class="card">
                <img
                  src="../images/services/single-services/blockchain/services-we-offer-7.png"
                  class="card-img-top"
                  alt="Development of whitepapers"
                />
                <div class="card-body">
                  <h5 class="card-title">Development of whitepapers</h5>
                  <p class="card-text">
                    We have a talented group of writers who can assist you in
                    creating a whitepaper. Create a report that is data-rich and
                    includes information on the issues, risk factors, and
                    possible remedies using their solid knowledge and
                    experience.
                  </p>
                </div>
              </div>
            ...
            <div class="col-md-6">
              <div class="card">
                <img
                  src="../images/services/single-services/blockchain/services-we-offer-8.png"
                  class="card-img-top"
                  alt="Services for Smart Contract Audit and Testing"
                />
                <div class="card-body">
                  <h5 class="card-title">
                    Services for Smart Contract Audit and Testing
                  </h5>
                  <p class="card-text">
                    To assist you in automating and securing your transactions,
                    we offer trustworthy auditing services for Hyperledger, EOS,
