...
<div class="row">
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    ...
                    <?php echo form_open_multipart('projectmanagement/pm_tasks/task_update/'.$id, array('class' => 'form-vertical', 'id' => 'update_task', 'name' => 'update_task')) ?>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea class="form-control" required name="summary" id="summary" rows="4" placeholder="<?php echo display('summary') ?>" tabindex="10" required><?php if(!empty($task_data->summary)){echo $task_data->summary;}?></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea class="form-control" required name="description" id="description" rows="5" placeholder="<?php echo display('description') ?>" tabindex="10" required><?php if(!empty($task_data->description)){echo $task_data->description;}?></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <label for="employee_id" class="col-sm-3 col-form-label"><?php echo display('assignee') ?> <i class="text-danger">*</i></label>
                                    <div class="col-sm-9">
                                        <?php if($task_data->task_status != 3){?>

                                            <?php echo form_dropdown('employee_id', $team_members, (!empty($task_data->employee_id)?$task_data->employee_id:""), ' class="form-control" required') ?> 

                                        <?php }else{?>

                                            <?php echo form_dropdown('employee_id', $team_members, (!empty($task_data->employee_id)?$task_data->employee_id:""), ' class="form-control"  disabled="true"') ?> 
