...
<div class="row">
    <div class="col-sm-12 col-md-12">
        <div class="panel panel-bd">
            ...
            <div class="panel-body">
                         ...
                         <?php echo  form_open_multipart('accounts/create_debit_voucher') ?>
       ...
       <select name="cmbCode[]" id="cmbCode_1" class="form-control" onchange="load_codeDebtv(this.value,1)">
   ...
   <option value="<?php echo $acc1->HeadCode;?>"><?php echo $acc1->HeadName;?></option>
         <?php }?>
                                        ...
                                        <td><input type="number" name="txtAmount[]" value="" class="form-control total_price text-right"  id="txtAmount_1" onkeyup="calculationDebtv(1)" >
                                           </td>
                                       <td>
