<link href="<?php echo base_url('application/modules/accounts/assets/css/update_journal_voucher.css'); ?>" rel="stylesheet" type="text/css"/>
...
<div class="row">
                                ...
                                <tbody id="debitvoucher">
                                   ...
                                   $total_credit = 0;
                                    foreach($voucher_info as $vinfo){
                                      ...
                                      ?>
                                    <tr>
                                        <td class="journalvoucher-headcode">  
   ...
   <option value="<?php echo $acc1->HeadCode;?>" <?php if($vinfo['COAID'] == $acc1->HeadCode){echo 'selected';}?>><?php echo $acc1->HeadName;?></option>
         <?php }?>
                                       ...
                                       <td>
                                                <button class="btn btn-danger red journalvoucher-button" type="button" value="<?php echo display('delete')?>" onclick="deleteRowJournalv(this)"><i class="fa fa-trash-o"></i></button>
                                            </td>
                                    </tr>   
                                    <?php $sl++;}?>                           
