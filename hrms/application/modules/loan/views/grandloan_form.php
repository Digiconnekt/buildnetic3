        ...
        <div class="col-sm-12 col-md-12">
            <div class="panel">
                ...
                <div class="panel-body">
                    ...
                    <?php echo  form_open('loan/Loan/create_grandloan') ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                   <?php echo form_dropdown('permission_by',$supervisor,null,'class="form-control" id="permission_by" ') ?>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="date_of_approve" class=" form-control datepicker"  placeholder="<?php echo display('date_of_approve') ?>" id="date_of_approve" >
                            </div>
                        </div> 
                        <div class="form-group row">
                            <label for="repayment_start_date" class=" col-sm-3 col-form-label"><?php echo display('repayment_start_date') ?> *</label>
                            <div class="col-sm-9">
                                <input type="text" name="repayment_start_date" class="   form-control datepicker"  placeholder="<?php echo display('repayment_start_date') ?>" id="repayment_start_date" >
                            </div>
                        </div> 
                        <div class="form-group row">
                            <label for="amount" class="col-sm-3 col-form-label"><?php echo display('amount') ?> *</label>
                            <div class="col-sm-9">
                                <input name="amount" class="form-control" type="number" placeholder="<?php echo display('amount') ?>" id="amount">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="number" name="interest_rate" class="form-control"  placeholder="<?php echo display('interest_rate') ?>" id="interest_rate" >
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="number" name="installment_period" class="form-control"  placeholder="<?php echo display('installment_period_m') ?>" id="installment_period" >
                            </div>
                        </div>   
                         <div class="form-group row">
                            <label for="repayment_amount" class="col-sm-3 col-form-label"><?php echo display('repayment_amount') ?> </label>
                            <div class="col-sm-9">
                                <input type="number" name="repayment_amount" class="form-control"  placeholder="<?php echo display('repayment_amount') ?>" id="repayment_amount" readonly>
                            </div>
                        </div>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="number" name="installment" class="form-control"  placeholder="<?php echo display('installment') ?>" id="installment" readonly>
                            </div>
                        </div> 
        ...
        <div class="panel panel-bd"> 
             ...
             <div class="panel-heading panel-aligner" >
                <div class="panel-title">
                    <h4><?php echo display('grant_loan') ?></h4>
                </div>
                <div class="mr-25">
