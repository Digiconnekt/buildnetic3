        ...
        <div class="col-sm-12 col-md-12">
            <div class="panel">
                ...
                <div class="panel-body">
                 <?php echo  form_open('loan/Loan/update_grnloan_form/'. $data->loan_id) ?>
                    ...
                    <input name="loan_id" type="hidden" value="<?php echo $data->loan_id ?>">
                       ...
                       <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input name="amount" class="form-control" type="number" placeholder="<?php echo display('amount') ?>" id="amount"  value="<?php echo $data->amount ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="number" name="interest_rate" class="form-control"  placeholder="<?php echo display('interest_rate') ?>" id="interest_rate"   value="<?php echo $data->interest_rate ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="number" name="installment_period" class="form-control"  placeholder="<?php echo display('installment_period_m') ?>" id="installment_period"  value="<?php echo $data->installment_period ?>">
                            </div>
                        </div>   
                         <div class="form-group row">
                            <label for="repayment_amount" class="col-sm-3 col-form-label"><?php echo display('repayment_amount') ?> </label>
                            <div class="col-sm-9">
                                <input type="number" name="repayment_amount" class="form-control"  placeholder="<?php echo display('repayment_amount') ?>" id="repayment_amount"  value="<?php echo $data->repayment_amount ?>" readonly>
                            </div>
                        </div>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="number" name="installment" class="form-control"  placeholder="<?php echo display('installment') ?>" id="installment"  value="<?php echo $data->installment ?>" readonly>
                            </div>
                        </div> 
