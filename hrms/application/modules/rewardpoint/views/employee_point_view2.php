...
<div class="row">
    ...
    <div class="col-sm-12">
        ...
        <div class="panel panel-default thumbnail"> 
            ...
            <div class="panel-body">
                <table width="100%" class="table table-striped table-bordered table-hover" id="EmpPointList">
                    <thead>
                        <tr>
...
<script src="<?php echo MOD_URL.'rewardpoint/assets/js/pointcustom.js'; ?>" type="text/javascript"></script>  
